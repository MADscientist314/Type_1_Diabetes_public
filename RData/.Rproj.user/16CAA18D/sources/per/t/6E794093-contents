...
lapply(rep(1:6), function(X) ggscatter(data = res_list[[X]],
                                      x= "log2FoldChange",
                                      y = "Genus",
                                      size = "log2FoldChange",
                                      size.range = c(-20,20),
                                      #title = paste0("Log2 fold Changes amongst Taxa Differentially associated with Type 1 Diabetes vs Control in", unique(res_list[[1]]$SampleType)),
                                      title = unique(res_list[[1]]$SampleType),
                                      color = "SampleType",
                                      fill="SampleType")+
